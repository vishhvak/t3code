    ...
    execute: () =>
      sql`
        SELECT
          ...
          voice_session_started_at AS "voiceSessionStartedAt",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                voiceSession:
                  row.voiceSessionStartedAt == null
                    ? null
                    : { startedAt: row.voiceSessionStartedAt },
                deletedAt: row.deletedAt,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        voiceSession:
          threadRow.value.voiceSessionStartedAt == null
            ? null
            : { startedAt: threadRow.value.voiceSessionStartedAt },
