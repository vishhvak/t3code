...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server can start Codex realtime voice sessions. Absent means unsupported,
      so clients hide the affordance under version skew. */
  realtimeVoice: Schema.optionalKey(Schema.Boolean),
